...
[locations]
top_dir=/opt/honssh</br>
log_dir=%(top_dir)s/logs</br>
attempt_dir=%(top_dir)s/logs</br>
session_dir=%(top_dir)s/sessions</br>
archive_dir = %(top_dir)s/archives</br>
...
[db_connection]
type=sqlite</br>
sqlite_dir=/usr/local/share/boing/db</br>
name=%(sqlite_dir)s/boing.db</br>
host=''</br>
port=''</br>
user=''</br>
password=''</br>
